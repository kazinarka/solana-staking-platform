...
use crate::consts::SECONDS_IN_THE_DAY;
...
impl Processor {
    pub fn process(
        ...
        let admin = "EU2vfi8fVXhJ9hqiXh4LFtY1HgdiPMejFDeaU1VEMXHa".parse::<Pubkey>().unwrap();
        let reward_mint = "EtwnUfYvaFau1qFxtm12LSwrPy3cAXQePK2WKPeMHKZm".parse::<Pubkey>().unwrap();
        ...
        match instruction {
            PlatformInstruction::GenerateVault => {
                ...
                if pda.owner != program_id {
                    ...
                    invoke_signed(
                        ...
                        &[&[vault_word.as_bytes(), &[vault_bump_seed.clone()]]],
                    )?;
            ...
            PlatformInstruction::AddToWhitelist { price, maxreward } => {
                ...
                let (data_address,data_address_bump) = Pubkey::find_program_address(&[whitelist_word.as_bytes(), &nft_info.key.to_bytes()], &program_id);
                ...
                if whitelist_info.owner != program_id {
                    ...
                    invoke_signed(
                        ...
                        &[&[whitelist_word.as_bytes(), &nft_info.key.to_bytes(), &[data_address_bump]]],
                    )?;
